...
var secuser = client.users.cache.get(args[0].value);
  ...
  .setTitle("Invite ME")
  .setColor('RANDOM')
  .addField("Invite to Discord server", "[Invite the bot here (Useless Bot)](https://discord.com/api/oauth2/authorize?client_id=883508432198574111&permissions=8&scope=bot)\n[Invite Super Music Bot here](https://discord.com/api/oauth2/authorize?client_id=883691211020443649&permissions=2205272384&redirect_uri=https%3A%2F%2Fsupermusic.gregetmaxs.repl.co%2Fapi%2Fcallback&response_type=code&scope=identify%20guilds%20bot%20applications.commands)")
 ...
 const embed = new Discord.MessageEmbed()
    ...
    .setTimestamp() 
        ...
        .addField("**:ticket: TICKET**", "`add`, `close`, `delete`, `new`, `open`, `remove`, `setup`\n\n**:performing_arts:REACTION ROLES**\n`reaction-role`, `reaction-role-remove`\n\n**:video_game: GAMES**\n`chess`,`poker`, `slots`, `tictactoe`\n\n**:frame_photo: IMAGE**\n`3000yr`, `approved`, `batslap`, `beautiful`, `brazzers`, `burn`, `cat`, `challenger`, `cuddle`, `dict`, `distort`, `dog`, `ddungeon`, `facechange`, `fire`, `flatearth`, `foxgirl`, `gay`, `hug`, `kiss`, `love`, `magik`, `meme`, `qrcode`, `randomav`, `rip`, `scary`, `slap`, `triggered`, `tickle`, `poke`, `tweet`, `vs`, `wanted`")


        .addField("**MODERATION**", "`announce`, `ban`, `color`, `hide`, `kick`, `lock`, `maintainence`, `nuke`, `prune`, `purge`, `say`, `sendembed`, `serverlock`, `serverunlock`, `set`, `slowmode`, `stealemoji`, `unban`, `unhide`, `unlock`, `vcid`, `voicedeafen`, `voicekick`, `voicemove`, `voicemute`, `voiceundeaf`, `voiceunmute`, `warn`, `warns`\n\n**:robot:CHATBOT**\n`remove-channel`, `set-channel`\n\n**UTILITY**\n`youtube`,csgo`,`avatar`, `covid`, `id`, `members`, `roleid`, `github`, `servericon`, `serverinfo`, `time`, `info`, `weather`")

        
 .addField("**Useless Bot Servers List**", "`setup-list`, `remove-list`")
        
        .setFooter(
          `Requested by ${interaction.member.user.username} | Total 150 Commands`,
