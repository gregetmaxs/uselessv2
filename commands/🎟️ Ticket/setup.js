...
module.exports = {
  ...
  if(log)
  {
    return message.reply(":X: You already have setuped the ticket box")
  }
message.guild.channels.create(`ticket-box`, {
 ...
 db.set(`setuped_${message.guild.id}`, channel.id);
    ...
    message.reply(":white_check_mark:  Done now i will only accept ticket messages from ticket-box channel")
  }}